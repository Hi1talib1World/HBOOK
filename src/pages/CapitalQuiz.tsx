...
const CapitalQuiz: React.FC<RouteComponentProps> = ({ history }) => {
  ...
  useEffect(() => {
    ...
    const generatedQuestions = selectedCountries.map(targetCountry => {
      // Pick 3 random wrong answers (capital cities)
      ...
      const options = [...wrongAnswers, targetCountry.capital].sort(() => 0.5 - Math.random());
      ...
      <IonContent fullscreen className="page-bg">
        <div className="quiz-container">
          ...
          <div className="flag-display-card" style={{ padding: '30px', textAlign: 'center', background: 'rgba(255,255,255,0.05)', borderRadius: '16px', marginBottom: '20px' }}>
            <h3 style={{ margin: 0, color: '#94a3b8', fontSize: '16px' }}>What is the capital city of</h3>
